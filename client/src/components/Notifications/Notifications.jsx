...
export default function Notifications() {
  const [{ sellerNotif }, dispatch] = useStateProvider();
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            >
              <BiBell id="dropdownNotification" className="text-base" />
              <p>Notifications ({sellerNotif.length})</p>
            </div>
            <div className="divide-y h-[24rem] overflow-y-auto divide-gray-100 dark:divide-gray-700">
              {sellerNotif.map((item) => (
                <Link
                  ...
                  <div className="flex-shrink-0">
                    {item.buyer.profileImage ? (
                      <img
                        ...
                        src={`${HOST}/${item.buyer.profileImage}`}
